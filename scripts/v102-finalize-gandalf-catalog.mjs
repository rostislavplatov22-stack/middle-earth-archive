...
const TARGET_PORTRAIT = "/v102/gandalf-catalog-card.webp";
const TARGET_WIDE = "/v102/gandalf-catalog-wide.webp";
...
const SKIP_PARTS = [
  ...
  "components/v102-gandalf-celestial-page.tsx",
];
