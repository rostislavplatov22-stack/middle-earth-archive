...
export default function V113FrodoDossierPage() {
  return (
    <main className="v113-frodo-page" aria-label="Фродо Бэггинс — Ring Bearer Dossier">
      ...
      <div className="v113-frodo-stage">
        <img
          src="/v113/frodo-dossier-approved.png"
          alt="Фродо Бэггинс — Ring Bearer Dossier"
          width="1672"
          height="941"
          className="v113-frodo-reference"
          decoding="async"
          fetchPriority="high"
        />
        ...
        <Link className="v113-hotspot v113-next" href="/characters/legolas" aria-label="Следующий персонаж" />
      </div>
    </main>
  );
}
